...
<div class="col-sm-11 clearfix">
 ...
 <img src="{{ site.url }}{{ site.baseurl }}/images/pubpic/{{ publi.image }}" width="200px" height="100px" alt="style="float: left" />
 {% endif %} -->

 {% if publi.number_image == 1 %}
 <img src="{{ site.url }}{{ site.baseurl }}/images/pubpic/{{ publi.image }}" width="200px" height="100px" style="float: left" />
 {% endif %}
